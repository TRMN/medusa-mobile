...
this["medusa"]["templates"]["memberinfo"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"container-fluid\">\n    <div class=\"row\">\n        <div class=\"col-xs-12 text-center\">\n            <h4 class=\"medusa-yellow\">"
    ...
    + ((stack1 = helpers["if"].call(alias3,((stack1 = (depth0 != null ? depth0.userinfo : depth0)) != null ? stack1.peerages : stack1),{"name":"if","hash":{},"fn":container.program(5, data, 0, blockParams, depths),"inverse":container.program(8, data, 0, blockParams, depths),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    ...
    + ((stack1 = helpers["if"].call(alias3,((stack1 = (depth0 != null ? depth0.userinfo : depth0)) != null ? stack1.exams : stack1),{"name":"if","hash":{},"fn":container.program(10, data, 0, blockParams, depths),"inverse":container.program(8, data, 0, blockParams, depths),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
